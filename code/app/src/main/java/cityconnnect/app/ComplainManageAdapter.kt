...
class ComplainManageAdapter (
    private val complains: MutableList<Complain>
) : RecyclerView.Adapter<ComplainManageAdapter.ComplainViewHolder>(), Filterable{
    ...
    inner class ComplainViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val ibSolved: ImageButton = itemView.findViewById(R.id.ibSolved)
        ...
        init {
            ibSolved.setOnClickListener {
                val position = adapterPosition
                if (position != RecyclerView.NO_POSITION) {
                    val currentComplain = filteredList[position]
                    imageButtonClickListener?.onImageButtonClick(currentComplain, ButtonType.SOLVED)
                }
            }
